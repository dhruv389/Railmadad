...
const DetailCard2 = ({ isOpen, onClose, title, text, icon }) => {
  ...
  return (
   ...
   <div className="flex justify-between h-full flex-col-reverse items-start ">
    ...
    <div className="w-[90%]">
  <h1 className="text-2xl font-bold">Delay in Train Arrival</h1>
  <p className="text-xl font-semibold text-gray-600 mt-2">Train No. <span className="text-black">12345</span></p>
  ...
  <div className="mt-6 flex gap-7 justify-start items-start">
    ...
    <p className="text-sm">CMP-20240904-001</p>
  </div>
  ...
  <div className="mt-4 flex gap-7 justify-start items-start">
    ...
    <p className="text-start text-sm">
      The train was delayed by over 2 hours without any prior notice. This caused significant inconvenience to passengers.
    </p>
  </div>

  <div className="mt-4 flex gap-7 justify-start items-start">
    <p className="text-sm font-bold text-gray-600">PNR Number</p>
    <p className="text-sm">PNR1234567890</p>
  </div>
